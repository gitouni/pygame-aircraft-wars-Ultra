scenes = dict(
     ...
     scene=[dict(type='scene1',
          ...
          dict(type='scene1',
               ...
               player_target=0),
          dict(type='scene2',
               point_list=[[0.45, 0.05], [0.43, 0.05], [0.39, 0.05], [0.36, 0.05], [0.32, 0.06], [0.3, 0.06], [0.29, 0.08], [0.32, 0.1], [0.35, 0.11], [0.39, 0.09], [0.4, 0.08], [0.4, 0.07], [0.38, 0.06], [0.34, 0.06], [0.32, 0.07], [0.34, 0.08], [0.38, 0.08], [0.41, 0.08], [0.42, 0.06], [0.4, 0.05], [0.36, 0.05], [0.32, 0.06], [0.31, 0.08], [0.33, 0.09], [0.37, 0.1], [0.41, 0.1], [0.44, 0.09], [0.46, 0.08], [0.45, 0.07], [0.41, 0.07], [0.36, 0.07], [0.34, 0.08], [0.34, 0.1], [0.36, 0.11], [0.4, 0.11], [0.43, 0.11], [0.46, 0.09], [0.46, 0.08], [0.45, 0.06], [0.42, 0.07]],
               enemy_id='eb1',
               enemy_fire_id=12,
               enemy_speed=0.5,
          ...
          dict(type='scene2',
               point_list=[[0.2, 0.14], [0.17, 0.15], [0.14, 0.15], [0.16, 0.17], [0.18, 0.17], [0.2, 0.17], [0.19, 0.15], [0.16, 0.15], [0.15, 0.17], [0.15, 0.18], [0.18, 0.18], [0.21, 0.18], [0.23, 0.18], [0.25, 0.16], [0.22, 0.16], [0.19, 0.16], [0.15, 0.16], [0.13, 0.16], [0.12, 0.18], [0.14, 0.2], [0.17, 0.2], [0.2, 0.2], [0.22, 0.19], [0.24, 0.18], [0.26, 0.17], [0.25, 0.15], [0.21, 0.16]],
               enemy_id='eb3',
               enemy_fire_id=7,
               enemy_speed=0.5,
               enemy_init_speed=1.5,
          ...
          dict(type='scene2',
               point_list=[[0.27, 0.07], [0.23, 0.07], [0.22, 0.09], [0.28, 0.11], [0.31, 0.11], [0.3, 0.08], [0.28, 0.08], [0.23, 0.08], [0.2, 0.09], [0.22, 0.11], [0.25, 0.12], [0.28, 0.1], [0.27, 0.09], [0.23, 0.08], [0.2, 0.1], [0.22, 0.11], [0.25, 0.12], [0.29, 0.11], [0.31, 0.1], [0.33, 0.09], [0.31, 0.08], [0.29, 0.06]],
               enemy_id='eb0',
               enemy_fire_id=10,
               enemy_speed=0.5,
               enemy_init_speed=1.5,
          ...
          dict(type='scene2',
               point_list=[[0.67, 0.42], [0.63, 0.42], [0.6, 0.43], [0.58, 0.43], [0.57, 0.45], [0.58, 0.47], [0.61, 0.48], [0.63, 0.48], [0.66, 0.47], [0.67, 0.45], [0.66, 0.44], [0.63, 0.44], [0.6, 0.44], [0.59, 0.45], [0.59, 0.47], [0.62, 0.47], [0.64, 0.47], [0.65, 0.45], [0.63, 0.45], [0.6, 0.45], [0.58, 0.45], [0.55, 0.46], [0.56, 0.47], [0.58, 0.48], [0.61, 0.49], [0.64, 0.49], [0.68, 0.48], [0.7, 0.48], [0.7, 0.46], [0.71, 0.44], [0.7, 0.43], [0.66, 0.44]],
               enemy_id='eb3',
               enemy_fire_id=11,
               enemy_speed=0.5,
               enemy_init_speed=1.5,
          ...
          dict(type='scene1',
               point_list=[[0.81, 1.02], [0.83, 0.25], [0.84, -0.06]],
               enemy_num=6,
               enemy_id='ea1',
               enemy_fire_id=3,
               bullet_time=0.7,
          ...
          dict(type='scene1',
               point_list=[[-0.18, 0.63], [0.71, 0.39], [1.18, 0.25]],
               enemy_num=10,
               enemy_id='ea3',
               enemy_fire_id=6,
               bullet_time=0.7,
          ...
          dict(type='scene1',
               point_list=[[0.36, -0.07], [0.36, -0.04], [0.36, -0.0], [0.37, 0.04], [0.38, 0.09], [0.39, 0.14], [0.4, 0.2], [0.42, 0.27], [0.46, 0.38], [0.49, 0.48], [0.48, 0.59], [0.45, 0.67], [0.41, 0.72], [0.39, 0.76], [0.37, 0.81], [0.35, 0.86], [0.35, 0.93], [0.35, 1.02], [0.38, 1.09]],
               enemy_num=10,
               enemy_id='ea4',
               enemy_fire_id=8,
               bullet_time=0.7,
          ...
          dict(type='scene2',
               point_list=[[0.45, 0.07], [0.42, 0.07], [0.4, 0.07], [0.38, 0.08], [0.37, 0.09], [0.36, 0.11], [0.38, 0.12], [0.41, 0.12], [0.44, 0.12], [0.46, 0.12], [0.47, 0.1], [0.46, 0.09], [0.44, 0.08], [0.41, 0.08], [0.39, 0.08], [0.37, 0.09], [0.39, 0.1], [0.42, 0.1], [0.41, 0.09], [0.39, 0.09], [0.37, 0.1], [0.38, 0.11], [0.41, 0.11], [0.43, 0.11], [0.45, 0.1], [0.47, 0.09], [0.47, 0.07]],
               enemy_id='eb0',
               enemy_fire_id=12,
               enemy_speed=0.5,
               enemy_init_speed=1.5,
          ...
          dict(type='scene2',
               point_list=[[0.25, 0.29], [0.22, 0.29], [0.19, 0.29], [0.17, 0.3], [0.16, 0.31], [0.17, 0.32], [0.18, 0.34], [0.2, 0.35], [0.22, 0.35], [0.25, 0.35], [0.26, 0.34], [0.26, 0.33], [0.25, 0.32], [0.24, 0.31], [0.21, 0.31], [0.19, 0.31], [0.17, 0.31], [0.15, 0.32], [0.16, 0.34], [0.18, 0.35], [0.21, 0.35], [0.24, 0.35], [0.25, 0.33], [0.24, 0.32], [0.22, 0.32], [0.2, 0.32], [0.17, 0.32], [0.15, 0.33], [0.16, 0.34], [0.17, 0.35], [0.19, 0.36], [0.22, 0.36], [0.25, 0.36], [0.27, 0.35], [0.29, 0.34], [0.3, 0.33], [0.3, 0.32], [0.29, 0.31], [0.28, 0.3], [0.25, 0.31]],
               enemy_id='eb3',
               enemy_fire_id=9,
               enemy_speed=0.5,
               enemy_init_speed=1.5,
          ...
          dict(type='scene1',
               point_list=[[0.5, 1.02], [0.55, 0.7], [0.57, 0.48], [0.56, 0.34], [0.54, 0.24], [0.53, 0.16], [0.53, 0.08], [0.52, 0.03], [0.53, -0.01], [0.57, -0.05]],
               enemy_num=12,
               enemy_id='ea3',
               enemy_fire_id=10,
               bullet_time=0.7,
          ...
          dict(type='scene1',
               point_list=[[0.3, 1.04], [0.3, 1.02], [0.3, 0.95], [0.31, 0.87], [0.31, 0.78], [0.32, 0.69], [0.32, 0.59], [0.32, 0.52], [0.32, 0.44], [0.32, 0.36], [0.32, 0.3], [0.32, 0.24], [0.32, 0.2], [0.33, 0.16], [0.33, 0.13], [0.33, 0.1], [0.33, 0.07], [0.33, 0.05], [0.32, 0.03], [0.32, 0.0], [0.32, -0.02], [0.32, -0.04], [0.32, -0.06]],
               enemy_num=16,
               enemy_id='ea2',
               enemy_fire_id=4,
               bullet_time=0.7,
               bullet_speed=3.0,
               bullet_target=[0.3,0.7],
               enemy_speed=4.5,
               dt=0.5,
               scene_time=67.0,
               player_target=1
...
if __name__ == "__main__":
     import json
     with open('uscenes/uscene1.json','w')as f:
          json.dump(scenes,f)