...
from elements import bullet, fighter
import yaml
import utils
...
class AutoGameRun:
    def __init__(self,gameset:game_set,globalset:utils.Setting,player_dict:dict,
    ...
    def run(self):
        ...
        player_info = Info(self.gameset.gold,self.gameset.diamond)
        ...
        self.gameset.high_score = max(gameset.high_score,player_info.score)
        self.quit_game()
...
def run_game():
    ...
    if GLOBAL_SET.win_open['game']:
        ...
        return
    init_pygame()
    game_run = AutoGameRun(gameset,GLOBAL_SET,player_dict,SIM_INTERVAL,VOLUME)
    game_run.run()
