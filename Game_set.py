...
class game_set():
    def __init__(self,file_path='data/game_set0.json'):
        ...
        self.player_shooting_cd_list = [390,330,275,195,150,90,60]  # 7
        ...
        self.shooting_cd_gold = [300,600,1800,4000,8000,12500]
        ...
        self.shooting_cd_diamond = [0, 0, 25, 75, 200, 500]
